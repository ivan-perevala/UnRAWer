...
void DropArea::dragEnterEvent(QDragEnterEvent *event) { event->acceptProposedAction(); }
...
MainWindow::MainWindow() {
  ...
  progressBar->setStyleSheet("QProgressBar {border: 0px solid black; border-radius: 3px; background-color: black; "
  ...
  textOutput->setStyleSheet(
      "border-radius: 3px; background-color: #181818; color: #E0E0E0; padding-left: 4px; padding-right: 4px;");
  // text size
  QFont font = this->font();
  font.setPointSize(8);
  ...
  menuBar->setStyleSheet("QMenuBar { background-color: #181818; color: #E0E0E0; }"
  ...
  auto createAction =
      [](const QString &title, QActionGroup *group, QMenu *menu, bool checkable = true, bool checked = false) {
  ...
  // Bits Depth
  std::vector<std::pair<const QString, int>> bitMenu = {{"Original", -1},
                                                        {"8 bits int", 0},
                                                        {"16 bits int", 1},
                                                        {"32 bits int", 2},
                                                        {"64 bits int", 3},
  ...
  std::vector<std::pair<const QString, int>> rawMenu = {
      {"Auto EXIF", -1}, {"0 Horizontal", 0}, {"-90 Vertical", 3}, {"+90 Vertical", 5}, {"180 Horizontal", 6}};
  ...
  // raw colorspace
  std::vector<std::pair<const QString, int>> rclrMenu = {// "Raw", "sRGB", "sRGB-linear", "Adobe", "Wide", "ProPhoto",
                                                         // "ProPhoto-linear", "XYZ", "ACES", "DCI-P3", "Rec2020"
                                                         {"Raw", 0},
                                                         {"sRGB", 1},
                                                         {"sRGB-linear", 2},
                                                         {"Adobe", 3},
  ...
  // lut transform
  std::vector<std::pair<const QString, int>> lutMenu = {{"Disabled", -1}, {"Smart", 0}, {"Forced", 1}};
  ...
  // sharpening
  std::vector<std::pair<const QString, int>> unsharpMenu = {{"Disabled", -1}, {"Smart", 0}, {"Forced", 1}};
...
void MainWindow::prntSettings() { printSettings(settings); }

void MainWindow::bitSettings() {
  std::vector<std::pair<QString, int>> actionMap = {{"original", -1},
                                                    {"8 bits int", 0},
                                                    {"16 bits int", 1},
                                                    {"32 bits int", 2},
                                                    {"64 bits int", 3},
...
void MainWindow::frmtSettings() {
  std::vector<std::pair<QString, int>> actionMap = {
      {"Original", -1}, {"TIFF", 0}, {"OpenEXR", 1}, {"PNG", 2}, {"JPEG", 3}, {"JPEG2000", 4}, {"PPM", 5}};
...
void MainWindow::rclrSettings() {
  std::vector<std::pair<QString, int>> actionMap = {// "Raw", "sRGB", "sRGB-linear", "Adobe", "Wide", "ProPhoto",
                                                    // "ProPhoto-linear", "XYZ", "ACES", "DCI-P3", "Rec2020"
                                                    {"Raw", 0},
                                                    {"sRGB", 1},
                                                    {"sRGB-linear", 2},
